...
* 在使用过程中出现任何问题，可以通过 [issues](https://github.com/TelDragon/frpc-IOS/issues) 来反馈。
...
**提醒：和项目相关的问题最好在 [issues](https://github.com/TelDragon/frpc-IOS/issues) 中反馈，这样方便其他有类似问题的人可以快速查找解决方法，并且也避免了我们重复回答一些问题。**

## 捐助

* 如果您觉得[frpc-IOS](https://github.com/TelDragon/frpc-IOS)对你有帮助，欢迎给予我们一定的捐助来维持项目的长期发展。
